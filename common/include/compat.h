 ...
 *
 * Kernel 3.13+, and RHEL 7.1 - 7.7 (kernel 3.10.0-229 - 3.10.0-1062): use only genl_unregister_family
 * Older kernels (but not RHEL 7.1 - 7.7): use genl_unregister_family and genl_unregister_ops
 */
